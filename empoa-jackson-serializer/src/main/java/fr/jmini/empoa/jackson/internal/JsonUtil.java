 ...
 */
//Adapted from https://github.com/smallrye/smallrye-open-api/blob/1.1.0/implementation/src/main/java/io/smallrye/openapi/runtime/io/JsonUtil.java
...
public final class JsonUtil {
    ...
    private static boolean isIntegerValue(BigDecimal bd) {
        return bd.signum() == 0 || bd.scale() <= 0 || bd.stripTrailingZeros()
                .scale() <= 0;
    }
}
