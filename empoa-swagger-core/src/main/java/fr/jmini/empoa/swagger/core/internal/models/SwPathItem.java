...
public class SwPathItem implements PathItem {
    ...
    private fr.jmini.empoa.swagger.core.internal.models.SwOperation _gET;

    private void initGET() {
        if (_swPathItem.getGet() == null) {
            _gET = null;
        } else if (_gET == null) {
            _gET = new fr.jmini.empoa.swagger.core.internal.models.SwOperation(_swPathItem.getGet());
        }
    }
    ...
    public void setGET(org.eclipse.microprofile.openapi.models.Operation gET) {
        if (gET != null) {
            if (!(gET instanceof fr.jmini.empoa.swagger.core.internal.models.SwOperation)) {
                throw new IllegalArgumentException("Unexpected type: " + gET);
            }
            _gET = (fr.jmini.empoa.swagger.core.internal.models.SwOperation) gET;
    ...
    private fr.jmini.empoa.swagger.core.internal.models.SwOperation _pUT;

    private void initPUT() {
        if (_swPathItem.getPut() == null) {
            _pUT = null;
        } else if (_pUT == null) {
            _pUT = new fr.jmini.empoa.swagger.core.internal.models.SwOperation(_swPathItem.getPut());
        }
    }
    ...
    public void setPUT(org.eclipse.microprofile.openapi.models.Operation pUT) {
        if (pUT != null) {
            if (!(pUT instanceof fr.jmini.empoa.swagger.core.internal.models.SwOperation)) {
                throw new IllegalArgumentException("Unexpected type: " + pUT);
            }
            _pUT = (fr.jmini.empoa.swagger.core.internal.models.SwOperation) pUT;
    ...
    private fr.jmini.empoa.swagger.core.internal.models.SwOperation _pOST;

    private void initPOST() {
        if (_swPathItem.getPost() == null) {
            _pOST = null;
        } else if (_pOST == null) {
            _pOST = new fr.jmini.empoa.swagger.core.internal.models.SwOperation(_swPathItem.getPost());
        }
    }
    ...
    public void setPOST(org.eclipse.microprofile.openapi.models.Operation pOST) {
        if (pOST != null) {
            if (!(pOST instanceof fr.jmini.empoa.swagger.core.internal.models.SwOperation)) {
                throw new IllegalArgumentException("Unexpected type: " + pOST);
            }
            _pOST = (fr.jmini.empoa.swagger.core.internal.models.SwOperation) pOST;
    ...
    private fr.jmini.empoa.swagger.core.internal.models.SwOperation _dELETE;

    private void initDELETE() {
        if (_swPathItem.getDelete() == null) {
            _dELETE = null;
        } else if (_dELETE == null) {
            _dELETE = new fr.jmini.empoa.swagger.core.internal.models.SwOperation(_swPathItem.getDelete());
        }
    }
    ...
    public void setDELETE(org.eclipse.microprofile.openapi.models.Operation dELETE) {
        if (dELETE != null) {
            if (!(dELETE instanceof fr.jmini.empoa.swagger.core.internal.models.SwOperation)) {
                throw new IllegalArgumentException("Unexpected type: " + dELETE);
            }
            _dELETE = (fr.jmini.empoa.swagger.core.internal.models.SwOperation) dELETE;
    ...
    private fr.jmini.empoa.swagger.core.internal.models.SwOperation _oPTIONS;

    private void initOPTIONS() {
        if (_swPathItem.getOptions() == null) {
            _oPTIONS = null;
        } else if (_oPTIONS == null) {
            _oPTIONS = new fr.jmini.empoa.swagger.core.internal.models.SwOperation(_swPathItem.getOptions());
        }
    }
    ...
    public void setOPTIONS(org.eclipse.microprofile.openapi.models.Operation oPTIONS) {
        if (oPTIONS != null) {
            if (!(oPTIONS instanceof fr.jmini.empoa.swagger.core.internal.models.SwOperation)) {
                throw new IllegalArgumentException("Unexpected type: " + oPTIONS);
            }
            _oPTIONS = (fr.jmini.empoa.swagger.core.internal.models.SwOperation) oPTIONS;
    ...
    private fr.jmini.empoa.swagger.core.internal.models.SwOperation _hEAD;

    private void initHEAD() {
        if (_swPathItem.getHead() == null) {
            _hEAD = null;
        } else if (_hEAD == null) {
            _hEAD = new fr.jmini.empoa.swagger.core.internal.models.SwOperation(_swPathItem.getHead());
        }
    }
    ...
    public void setHEAD(org.eclipse.microprofile.openapi.models.Operation hEAD) {
        if (hEAD != null) {
            if (!(hEAD instanceof fr.jmini.empoa.swagger.core.internal.models.SwOperation)) {
                throw new IllegalArgumentException("Unexpected type: " + hEAD);
            }
            _hEAD = (fr.jmini.empoa.swagger.core.internal.models.SwOperation) hEAD;
    ...
    private fr.jmini.empoa.swagger.core.internal.models.SwOperation _pATCH;

    private void initPATCH() {
        if (_swPathItem.getPatch() == null) {
            _pATCH = null;
        } else if (_pATCH == null) {
            _pATCH = new fr.jmini.empoa.swagger.core.internal.models.SwOperation(_swPathItem.getPatch());
        }
    }
    ...
    public void setPATCH(org.eclipse.microprofile.openapi.models.Operation pATCH) {
        if (pATCH != null) {
            if (!(pATCH instanceof fr.jmini.empoa.swagger.core.internal.models.SwOperation)) {
                throw new IllegalArgumentException("Unexpected type: " + pATCH);
            }
            _pATCH = (fr.jmini.empoa.swagger.core.internal.models.SwOperation) pATCH;
    ...
    private fr.jmini.empoa.swagger.core.internal.models.SwOperation _tRACE;

    private void initTRACE() {
        if (_swPathItem.getTrace() == null) {
            _tRACE = null;
        } else if (_tRACE == null) {
            _tRACE = new fr.jmini.empoa.swagger.core.internal.models.SwOperation(_swPathItem.getTrace());
        }
    }
    ...
    public void setTRACE(org.eclipse.microprofile.openapi.models.Operation tRACE) {
        if (tRACE != null) {
            if (!(tRACE instanceof fr.jmini.empoa.swagger.core.internal.models.SwOperation)) {
                throw new IllegalArgumentException("Unexpected type: " + tRACE);
            }
            _tRACE = (fr.jmini.empoa.swagger.core.internal.models.SwOperation) tRACE;
    ...
    private java.util.List<fr.jmini.empoa.swagger.core.internal.models.servers.SwServer> _servers;
    ...
    private void initServers() {
        if (_swPathItem.getServers() == null) {
            ...
            _servers = _swPathItem.getServers()
                    .stream()
                    .map(fr.jmini.empoa.swagger.core.internal.models.servers.SwServer::new)
    ...
    public PathItem addServer(org.eclipse.microprofile.openapi.models.servers.Server server) {
        if (!(server instanceof fr.jmini.empoa.swagger.core.internal.models.servers.SwServer)) {
            throw new IllegalArgumentException("Unexpected type: " + server);
        }
        fr.jmini.empoa.swagger.core.internal.models.servers.SwServer element = (fr.jmini.empoa.swagger.core.internal.models.servers.SwServer) server;
        initServers();
        if (_servers == null) {
    ...
    private java.util.List<fr.jmini.empoa.swagger.core.internal.models.parameters.SwParameter> _parameters;
    ...
    private void initParameters() {
        if (_swPathItem.getParameters() == null) {
            ...
            _parameters = _swPathItem.getParameters()
                    .stream()
                    .map(fr.jmini.empoa.swagger.core.internal.models.parameters.SwParameter::new)
                    .collect(java.util.stream.Collectors.toCollection(java.util.ArrayList::new));
        }
    }
    ...
    public PathItem addParameter(org.eclipse.microprofile.openapi.models.parameters.Parameter parameter) {
        ...
        fr.jmini.empoa.swagger.core.internal.models.parameters.SwParameter element = (fr.jmini.empoa.swagger.core.internal.models.parameters.SwParameter) parameter;
        initParameters();
        if (_parameters == null) {
