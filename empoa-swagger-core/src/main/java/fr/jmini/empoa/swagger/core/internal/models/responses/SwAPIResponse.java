 ...
 * the License.
 ******************************************************************************/
package fr.jmini.empoa.swagger.core.internal.models.responses;
...
public class SwAPIResponse implements APIResponse {
    ...
    private fr.jmini.empoa.swagger.core.internal.models.media.SwContent _content;

    private void initContent() {
        if (_swAPIResponse.getContent() == null) {
            _content = null;
        } else if (_content == null) {
            _content = new fr.jmini.empoa.swagger.core.internal.models.media.SwContent(_swAPIResponse.getContent());
        }
    }
    ...
    public void setContent(org.eclipse.microprofile.openapi.models.media.Content content) {
        if (content != null) {
            if (!(content instanceof fr.jmini.empoa.swagger.core.internal.models.media.SwContent)) {
                throw new IllegalArgumentException("Unexpected type: " + content);
            }
            _content = (fr.jmini.empoa.swagger.core.internal.models.media.SwContent) content;
