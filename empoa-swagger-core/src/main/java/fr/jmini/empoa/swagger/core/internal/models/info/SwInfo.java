...
public class SwInfo implements Info {
    ...
    private fr.jmini.empoa.swagger.core.internal.models.info.SwContact _contact;

    private void initContact() {
        if (_swInfo.getContact() == null) {
            _contact = null;
        } else if (_contact == null) {
            _contact = new fr.jmini.empoa.swagger.core.internal.models.info.SwContact(_swInfo.getContact());
        }
    }
    ...
    public void setContact(org.eclipse.microprofile.openapi.models.info.Contact contact) {
        if (contact != null) {
            if (!(contact instanceof fr.jmini.empoa.swagger.core.internal.models.info.SwContact)) {
                throw new IllegalArgumentException("Unexpected type: " + contact);
            }
            _contact = (fr.jmini.empoa.swagger.core.internal.models.info.SwContact) contact;
    ...
    private fr.jmini.empoa.swagger.core.internal.models.info.SwLicense _license;

    private void initLicense() {
        if (_swInfo.getLicense() == null) {
            _license = null;
        } else if (_license == null) {
            _license = new fr.jmini.empoa.swagger.core.internal.models.info.SwLicense(_swInfo.getLicense());
        }
    }
    ...
    public void setLicense(org.eclipse.microprofile.openapi.models.info.License license) {
        if (license != null) {
            if (!(license instanceof fr.jmini.empoa.swagger.core.internal.models.info.SwLicense)) {
                throw new IllegalArgumentException("Unexpected type: " + license);
            }
            _license = (fr.jmini.empoa.swagger.core.internal.models.info.SwLicense) license;
