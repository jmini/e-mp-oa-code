package fr.jmini.empoa.swagger.core.internal.models.media;
...
public class SwSchema implements Schema {
    ...
    private fr.jmini.empoa.swagger.core.internal.models.media.SwDiscriminator _discriminator;

    private void initDiscriminator() {
        if (_swSchema.getDiscriminator() == null) {
            _discriminator = null;
        } else if (_discriminator == null) {
            _discriminator = new fr.jmini.empoa.swagger.core.internal.models.media.SwDiscriminator(_swSchema.getDiscriminator());
        }
    }
    ...
    public void setDiscriminator(org.eclipse.microprofile.openapi.models.media.Discriminator discriminator) {
        if (discriminator != null) {
            if (!(discriminator instanceof fr.jmini.empoa.swagger.core.internal.models.media.SwDiscriminator)) {
                throw new IllegalArgumentException("Unexpected type: " + discriminator);
            }
            _discriminator = (fr.jmini.empoa.swagger.core.internal.models.media.SwDiscriminator) discriminator;
    ...
    private fr.jmini.empoa.swagger.core.internal.models.media.SwSchema _not;

    private void initNot() {
        if (_swSchema.getNot() == null) {
            _not = null;
        } else if (_not == null) {
            _not = new fr.jmini.empoa.swagger.core.internal.models.media.SwSchema(_swSchema.getNot());
        }
    }
    ...
    public void setNot(org.eclipse.microprofile.openapi.models.media.Schema not) {
        if (not != null) {
            if (!(not instanceof fr.jmini.empoa.swagger.core.internal.models.media.SwSchema)) {
                throw new IllegalArgumentException("Unexpected type: " + not);
            }
            _not = (fr.jmini.empoa.swagger.core.internal.models.media.SwSchema) not;
    ...
    private java.util.Map<String, fr.jmini.empoa.swagger.core.internal.models.media.SwSchema> _properties;
    ...
    private fr.jmini.empoa.swagger.core.internal.models.media.SwSchema _additionalPropertiesSchema;
    ...
    private void initAdditionalPropertiesSchema() {
        if (_additionalPropertiesSchema == null) {
            if (_swSchema.getAdditionalProperties() instanceof io.swagger.v3.oas.models.media.Schema) {
                _additionalPropertiesSchema = new fr.jmini.empoa.swagger.core.internal.models.media.SwSchema((io.swagger.v3.oas.models.media.Schema) _swSchema.getAdditionalProperties());
            } else {
    ...
    public void setAdditionalPropertiesSchema(Schema additionalProperties) {
        if (additionalProperties != null) {
            if (!(additionalProperties instanceof fr.jmini.empoa.swagger.core.internal.models.media.SwSchema)) {
                throw new IllegalArgumentException("Unexpected type: " + additionalProperties);
            }
            _additionalPropertiesSchema = (fr.jmini.empoa.swagger.core.internal.models.media.SwSchema) additionalProperties;
    ...
    private fr.jmini.empoa.swagger.core.internal.models.SwExternalDocumentation _externalDocs;

    private void initExternalDocs() {
        if (_swSchema.getExternalDocs() == null) {
            _externalDocs = null;
        } else if (_externalDocs == null) {
            _externalDocs = new fr.jmini.empoa.swagger.core.internal.models.SwExternalDocumentation(_swSchema.getExternalDocs());
        }
    }
    ...
    public void setExternalDocs(org.eclipse.microprofile.openapi.models.ExternalDocumentation externalDocs) {
        if (externalDocs != null) {
            if (!(externalDocs instanceof fr.jmini.empoa.swagger.core.internal.models.SwExternalDocumentation)) {
                throw new IllegalArgumentException("Unexpected type: " + externalDocs);
            }
            _externalDocs = (fr.jmini.empoa.swagger.core.internal.models.SwExternalDocumentation) externalDocs;
    ...
    private fr.jmini.empoa.swagger.core.internal.models.media.SwXML _xml;

    private void initXml() {
        if (_swSchema.getXml() == null) {
            _xml = null;
        } else if (_xml == null) {
            _xml = new fr.jmini.empoa.swagger.core.internal.models.media.SwXML(_swSchema.getXml());
        }
    }
    ...
    public void setXml(org.eclipse.microprofile.openapi.models.media.XML xml) {
        if (xml != null) {
            if (!(xml instanceof fr.jmini.empoa.swagger.core.internal.models.media.SwXML)) {
                throw new IllegalArgumentException("Unexpected type: " + xml);
            }
            _xml = (fr.jmini.empoa.swagger.core.internal.models.media.SwXML) xml;
    ...
    private fr.jmini.empoa.swagger.core.internal.models.media.SwSchema _items;
    ...
    private void initItems() {
        if (_items == null) {
            if (_swSchema instanceof io.swagger.v3.oas.models.media.ArraySchema && ((io.swagger.v3.oas.models.media.ArraySchema) _swSchema).getItems() != null) {
                _items = new fr.jmini.empoa.swagger.core.internal.models.media.SwSchema(((io.swagger.v3.oas.models.media.ArraySchema) _swSchema).getItems());
            } else {
                _items = null;
            }
        }
    ...
    public void setItems(org.eclipse.microprofile.openapi.models.media.Schema items) {
        if (items != null) {
            if (!(items instanceof fr.jmini.empoa.swagger.core.internal.models.media.SwSchema)) {
            ...
            _items = (fr.jmini.empoa.swagger.core.internal.models.media.SwSchema) items;
    ...
    private java.util.List<fr.jmini.empoa.swagger.core.internal.models.media.SwSchema> _allOf;
        ...
        if (_allOf == null) {
            if (!(_swSchema instanceof io.swagger.v3.oas.models.media.ComposedSchema) || ((io.swagger.v3.oas.models.media.ComposedSchema) _swSchema).getAllOf() == null) {
                ...
                _allOf = ((io.swagger.v3.oas.models.media.ComposedSchema) _swSchema).getAllOf()
                        .stream()
                        .map(fr.jmini.empoa.swagger.core.internal.models.media.SwSchema::new)
    ...
    public Schema addAllOf(org.eclipse.microprofile.openapi.models.media.Schema schema) {
        ...
        fr.jmini.empoa.swagger.core.internal.models.media.SwSchema element = (fr.jmini.empoa.swagger.core.internal.models.media.SwSchema) schema;
        if (!(_swSchema instanceof io.swagger.v3.oas.models.media.ComposedSchema)) {
            _swSchema = transformToComposedSchema(_swSchema);
        }
        initAllOf();
    ...
    private java.util.List<fr.jmini.empoa.swagger.core.internal.models.media.SwSchema> _anyOf;
    ...
    private java.util.List<fr.jmini.empoa.swagger.core.internal.models.media.SwSchema> _oneOf;
