package fr.jmini.empoa.swagger.core.internal.models.parameters;
...
public class SwParameter implements Parameter {
    ...
    private void initSchema() {
        if (_swParameter.getSchema() == null) {
            ...
            _schema = new fr.jmini.empoa.swagger.core.internal.models.media.SwSchema(_swParameter.getSchema());
        }
    }
    ...
    private void initContent() {
        if (_swParameter.getContent() == null) {
            ...
            _content = new fr.jmini.empoa.swagger.core.internal.models.media.SwContent(_swParameter.getContent());
        }
    }
