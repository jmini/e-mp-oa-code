...
public class SwOperation implements Operation {
    ...
    private void initExternalDocs() {
        if (_swOperation.getExternalDocs() == null) {
            ...
            _externalDocs = new fr.jmini.empoa.swagger.core.internal.models.SwExternalDocumentation(_swOperation.getExternalDocs());
        }
    }
    ...
    private fr.jmini.empoa.swagger.core.internal.models.parameters.SwRequestBody _requestBody;

    private void initRequestBody() {
        if (_swOperation.getRequestBody() == null) {
            _requestBody = null;
        } else if (_requestBody == null) {
            _requestBody = new fr.jmini.empoa.swagger.core.internal.models.parameters.SwRequestBody(_swOperation.getRequestBody());
        }
    }
    ...
    public void setRequestBody(org.eclipse.microprofile.openapi.models.parameters.RequestBody requestBody) {
        if (requestBody != null) {
            ...
            _requestBody = (fr.jmini.empoa.swagger.core.internal.models.parameters.SwRequestBody) requestBody;
    ...
    private fr.jmini.empoa.swagger.core.internal.models.responses.SwAPIResponses _responses;

    private void initResponses() {
        if (_swOperation.getResponses() == null) {
            _responses = null;
        } else if (_responses == null) {
            _responses = new fr.jmini.empoa.swagger.core.internal.models.responses.SwAPIResponses(_swOperation.getResponses());
        }
    }
    ...
    public void setResponses(org.eclipse.microprofile.openapi.models.responses.APIResponses responses) {
        if (responses != null) {
            if (!(responses instanceof fr.jmini.empoa.swagger.core.internal.models.responses.SwAPIResponses)) {
                throw new IllegalArgumentException("Unexpected type: " + responses);
            }
            _responses = (fr.jmini.empoa.swagger.core.internal.models.responses.SwAPIResponses) responses;
    ...
    private java.util.List<fr.jmini.empoa.swagger.core.internal.models.security.SwSecurityRequirement> _security;
    ...
    private void initSecurity() {
        if (_swOperation.getSecurity() == null) {
            ...
            _security = _swOperation.getSecurity()
                    .stream()
                    .map(fr.jmini.empoa.swagger.core.internal.models.security.SwSecurityRequirement::new)
                    .collect(java.util.stream.Collectors.toCollection(java.util.ArrayList::new));
        }
    }
    ...
    public Operation addSecurityRequirement(org.eclipse.microprofile.openapi.models.security.SecurityRequirement securityRequirement) {
        if (!(securityRequirement instanceof fr.jmini.empoa.swagger.core.internal.models.security.SwSecurityRequirement)) {
            throw new IllegalArgumentException("Unexpected type: " + securityRequirement);
        }
        fr.jmini.empoa.swagger.core.internal.models.security.SwSecurityRequirement element = (fr.jmini.empoa.swagger.core.internal.models.security.SwSecurityRequirement) securityRequirement;
        initSecurity();
        if (_security == null) {
