...
public class SwOAuthFlows implements OAuthFlows {
    ...
    private fr.jmini.empoa.swagger.core.internal.models.security.SwOAuthFlow _implicit;

    private void initImplicit() {
        if (_swOAuthFlows.getImplicit() == null) {
            _implicit = null;
        } else if (_implicit == null) {
            _implicit = new fr.jmini.empoa.swagger.core.internal.models.security.SwOAuthFlow(_swOAuthFlows.getImplicit());
        }
    }
    ...
    public void setImplicit(org.eclipse.microprofile.openapi.models.security.OAuthFlow implicit) {
        if (implicit != null) {
            if (!(implicit instanceof fr.jmini.empoa.swagger.core.internal.models.security.SwOAuthFlow)) {
                throw new IllegalArgumentException("Unexpected type: " + implicit);
            }
            _implicit = (fr.jmini.empoa.swagger.core.internal.models.security.SwOAuthFlow) implicit;
    ...
    private fr.jmini.empoa.swagger.core.internal.models.security.SwOAuthFlow _password;

    private void initPassword() {
        if (_swOAuthFlows.getPassword() == null) {
            _password = null;
        } else if (_password == null) {
            _password = new fr.jmini.empoa.swagger.core.internal.models.security.SwOAuthFlow(_swOAuthFlows.getPassword());
        }
    }
    ...
    public void setPassword(org.eclipse.microprofile.openapi.models.security.OAuthFlow password) {
        if (password != null) {
            if (!(password instanceof fr.jmini.empoa.swagger.core.internal.models.security.SwOAuthFlow)) {
                throw new IllegalArgumentException("Unexpected type: " + password);
            }
            _password = (fr.jmini.empoa.swagger.core.internal.models.security.SwOAuthFlow) password;
    ...
    private fr.jmini.empoa.swagger.core.internal.models.security.SwOAuthFlow _clientCredentials;
    ...
    private void initClientCredentials() {
        if (_swOAuthFlows.getClientCredentials() == null) {
            ...
            _clientCredentials = new fr.jmini.empoa.swagger.core.internal.models.security.SwOAuthFlow(_swOAuthFlows.getClientCredentials());
        }
    }
    ...
    public void setClientCredentials(org.eclipse.microprofile.openapi.models.security.OAuthFlow clientCredentials) {
        if (clientCredentials != null) {
            if (!(clientCredentials instanceof fr.jmini.empoa.swagger.core.internal.models.security.SwOAuthFlow)) {
                throw new IllegalArgumentException("Unexpected type: " + clientCredentials);
            }
            _clientCredentials = (fr.jmini.empoa.swagger.core.internal.models.security.SwOAuthFlow) clientCredentials;
    ...
    private fr.jmini.empoa.swagger.core.internal.models.security.SwOAuthFlow _authorizationCode;

    private void initAuthorizationCode() {
        if (_swOAuthFlows.getAuthorizationCode() == null) {
            _authorizationCode = null;
        } else if (_authorizationCode == null) {
            _authorizationCode = new fr.jmini.empoa.swagger.core.internal.models.security.SwOAuthFlow(_swOAuthFlows.getAuthorizationCode());
        }
    }
    ...
    public void setAuthorizationCode(org.eclipse.microprofile.openapi.models.security.OAuthFlow authorizationCode) {
        if (authorizationCode != null) {
            if (!(authorizationCode instanceof fr.jmini.empoa.swagger.core.internal.models.security.SwOAuthFlow)) {
                throw new IllegalArgumentException("Unexpected type: " + authorizationCode);
            }
            _authorizationCode = (fr.jmini.empoa.swagger.core.internal.models.security.SwOAuthFlow) authorizationCode;
