 ...
 * the License.
 ******************************************************************************/
package fr.jmini.empoa.swagger.core.internal.models.tags;
...
public class SwTag implements Tag {
    ...
    private void initExternalDocs() {
        if (_swTag.getExternalDocs() == null) {
            ...
            _externalDocs = new fr.jmini.empoa.swagger.core.internal.models.SwExternalDocumentation(_swTag.getExternalDocs());
        }
    }
