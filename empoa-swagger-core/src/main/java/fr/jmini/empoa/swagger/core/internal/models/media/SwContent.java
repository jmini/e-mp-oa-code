...
public class SwContent implements Content {
    ...
    private java.util.Map<String, fr.jmini.empoa.swagger.core.internal.models.media.SwMediaType> _mediaTypes;
        ...
        if (_swContent == null) {
            ...
            _mediaTypes = _swContent
                    ...
                    .collect(java.util.stream.Collectors.toMap(
                            ...
                            e -> new fr.jmini.empoa.swagger.core.internal.models.media.SwMediaType(e.getValue()),
                            (k1, k2) -> {
                                throw new IllegalStateException(String.format("Duplicate key %s", k1));
                            },
                            () -> new java.util.LinkedHashMap<String, fr.jmini.empoa.swagger.core.internal.models.media.SwMediaType>()));
        }
    }
    ...
    public Content addMediaType(String key, org.eclipse.microprofile.openapi.models.media.MediaType mediaType) {
        if (!(mediaType instanceof fr.jmini.empoa.swagger.core.internal.models.media.SwMediaType)) {
            throw new IllegalArgumentException("Unexpected type: " + mediaType);
        }
        fr.jmini.empoa.swagger.core.internal.models.media.SwMediaType value = (fr.jmini.empoa.swagger.core.internal.models.media.SwMediaType) mediaType;
        initMediaTypes();
        if (_mediaTypes == null) {
            _mediaTypes = new java.util.LinkedHashMap<>();
        }
