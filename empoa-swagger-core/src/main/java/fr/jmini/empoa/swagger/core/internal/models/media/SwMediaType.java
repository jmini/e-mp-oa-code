...
public class SwMediaType implements MediaType {
    ...
    private fr.jmini.empoa.swagger.core.internal.models.media.SwSchema _schema;

    private void initSchema() {
        if (_swMediaType.getSchema() == null) {
            _schema = null;
        } else if (_schema == null) {
            _schema = new fr.jmini.empoa.swagger.core.internal.models.media.SwSchema(_swMediaType.getSchema());
        }
    }
    ...
    public void setSchema(org.eclipse.microprofile.openapi.models.media.Schema schema) {
        if (schema != null) {
            ...
            _schema = (fr.jmini.empoa.swagger.core.internal.models.media.SwSchema) schema;
    ...
    private java.util.Map<String, fr.jmini.empoa.swagger.core.internal.models.media.SwEncoding> _encoding;
    ...
    private void initEncoding() {
        if (_swMediaType.getEncoding() == null) {
            ...
            _encoding = _swMediaType.getEncoding()
                    ...
                    .collect(java.util.stream.Collectors.toMap(
                            java.util.Map.Entry::getKey,
                            e -> new fr.jmini.empoa.swagger.core.internal.models.media.SwEncoding(e.getValue()),
                            (k1, k2) -> {
                                throw new IllegalStateException(String.format("Duplicate key %s", k1));
                            },
                            () -> new java.util.LinkedHashMap<String, fr.jmini.empoa.swagger.core.internal.models.media.SwEncoding>()));
        }
    }
    ...
    public MediaType addEncoding(String key, org.eclipse.microprofile.openapi.models.media.Encoding encoding) {
        if (!(encoding instanceof fr.jmini.empoa.swagger.core.internal.models.media.SwEncoding)) {
            throw new IllegalArgumentException("Unexpected type: " + encoding);
        }
        fr.jmini.empoa.swagger.core.internal.models.media.SwEncoding value = (fr.jmini.empoa.swagger.core.internal.models.media.SwEncoding) encoding;
        initEncoding();
        if (_encoding == null) {
