 ...
 * the License.
 ******************************************************************************/
package fr.jmini.empoa.swagger.core.internal.models.servers;
...
public class SwServerVariables implements ServerVariables {
    ...
    private java.util.Map<String, fr.jmini.empoa.swagger.core.internal.models.servers.SwServerVariable> _serverVariables;
        ...
        if (_swServerVariables == null) {
            ...
            _serverVariables = _swServerVariables
                    ...
                    .collect(java.util.stream.Collectors.toMap(
                            ...
                            e -> new fr.jmini.empoa.swagger.core.internal.models.servers.SwServerVariable(e.getValue()),
                            (k1, k2) -> {
                                throw new IllegalStateException(String.format("Duplicate key %s", k1));
                            },
                            () -> new java.util.LinkedHashMap<String, fr.jmini.empoa.swagger.core.internal.models.servers.SwServerVariable>()));
        }
    }
    ...
    public ServerVariables addServerVariable(String key, org.eclipse.microprofile.openapi.models.servers.ServerVariable serverVariable) {
        if (!(serverVariable instanceof fr.jmini.empoa.swagger.core.internal.models.servers.SwServerVariable)) {
            throw new IllegalArgumentException("Unexpected type: " + serverVariable);
        }
        fr.jmini.empoa.swagger.core.internal.models.servers.SwServerVariable value = (fr.jmini.empoa.swagger.core.internal.models.servers.SwServerVariable) serverVariable;
        initServerVariables();
        if (_serverVariables == null) {
            _serverVariables = new java.util.LinkedHashMap<>();
        }
