package fr.jmini.empoa.swagger.core.internal.models.headers;
...
public class SwHeader implements Header {
    ...
    private void initSchema() {
        if (_swHeader.getSchema() == null) {
            ...
            _schema = new fr.jmini.empoa.swagger.core.internal.models.media.SwSchema(_swHeader.getSchema());
        }
    }
    ...
    private void initContent() {
        if (_swHeader.getContent() == null) {
            ...
            _content = new fr.jmini.empoa.swagger.core.internal.models.media.SwContent(_swHeader.getContent());
        }
    }
