...
public class SwOpenAPI implements OpenAPI {
    ...
    private fr.jmini.empoa.swagger.core.internal.models.info.SwInfo _info;

    private void initInfo() {
        if (_swOpenAPI.getInfo() == null) {
            _info = null;
        } else if (_info == null) {
            _info = new fr.jmini.empoa.swagger.core.internal.models.info.SwInfo(_swOpenAPI.getInfo());
        }
    }
    ...
    public void setInfo(org.eclipse.microprofile.openapi.models.info.Info info) {
        if (info != null) {
            if (!(info instanceof fr.jmini.empoa.swagger.core.internal.models.info.SwInfo)) {
                throw new IllegalArgumentException("Unexpected type: " + info);
            }
            _info = (fr.jmini.empoa.swagger.core.internal.models.info.SwInfo) info;
    ...
    private void initExternalDocs() {
        if (_swOpenAPI.getExternalDocs() == null) {
            ...
            _externalDocs = new fr.jmini.empoa.swagger.core.internal.models.SwExternalDocumentation(_swOpenAPI.getExternalDocs());
        }
    }
    ...
    private java.util.List<fr.jmini.empoa.swagger.core.internal.models.tags.SwTag> _tags;
    ...
    private void initTags() {
        if (_swOpenAPI.getTags() == null) {
            ...
            _tags = _swOpenAPI.getTags()
                    .stream()
                    .map(fr.jmini.empoa.swagger.core.internal.models.tags.SwTag::new)
                    .collect(java.util.stream.Collectors.toCollection(java.util.ArrayList::new));
        }
    }
    ...
    public OpenAPI addTag(org.eclipse.microprofile.openapi.models.tags.Tag tag) {
        if (!(tag instanceof fr.jmini.empoa.swagger.core.internal.models.tags.SwTag)) {
            throw new IllegalArgumentException("Unexpected type: " + tag);
        }
        fr.jmini.empoa.swagger.core.internal.models.tags.SwTag element = (fr.jmini.empoa.swagger.core.internal.models.tags.SwTag) tag;
        initTags();
        if (_tags == null) {
    ...
    private fr.jmini.empoa.swagger.core.internal.models.SwPaths _paths;

    private void initPaths() {
        if (_swOpenAPI.getPaths() == null) {
            _paths = null;
        } else if (_paths == null) {
            _paths = new fr.jmini.empoa.swagger.core.internal.models.SwPaths(_swOpenAPI.getPaths());
        }
    }
    ...
    public void setPaths(org.eclipse.microprofile.openapi.models.Paths paths) {
        if (paths != null) {
            if (!(paths instanceof fr.jmini.empoa.swagger.core.internal.models.SwPaths)) {
                throw new IllegalArgumentException("Unexpected type: " + paths);
            }
            _paths = (fr.jmini.empoa.swagger.core.internal.models.SwPaths) paths;
    ...
    private fr.jmini.empoa.swagger.core.internal.models.SwComponents _components;

    private void initComponents() {
        if (_swOpenAPI.getComponents() == null) {
            _components = null;
        } else if (_components == null) {
            _components = new fr.jmini.empoa.swagger.core.internal.models.SwComponents(_swOpenAPI.getComponents());
        }
    }
    ...
    public void setComponents(org.eclipse.microprofile.openapi.models.Components components) {
        if (components != null) {
            if (!(components instanceof fr.jmini.empoa.swagger.core.internal.models.SwComponents)) {
                throw new IllegalArgumentException("Unexpected type: " + components);
            }
            _components = (fr.jmini.empoa.swagger.core.internal.models.SwComponents) components;
