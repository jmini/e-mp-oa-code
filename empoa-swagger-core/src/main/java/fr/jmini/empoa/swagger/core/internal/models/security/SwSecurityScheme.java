...
public class SwSecurityScheme implements SecurityScheme {
    ...
    private fr.jmini.empoa.swagger.core.internal.models.security.SwOAuthFlows _flows;

    private void initFlows() {
        if (_swSecurityScheme.getFlows() == null) {
            _flows = null;
        } else if (_flows == null) {
            _flows = new fr.jmini.empoa.swagger.core.internal.models.security.SwOAuthFlows(_swSecurityScheme.getFlows());
        }
    }
    ...
    public void setFlows(org.eclipse.microprofile.openapi.models.security.OAuthFlows flows) {
        if (flows != null) {
            if (!(flows instanceof fr.jmini.empoa.swagger.core.internal.models.security.SwOAuthFlows)) {
                throw new IllegalArgumentException("Unexpected type: " + flows);
            }
            _flows = (fr.jmini.empoa.swagger.core.internal.models.security.SwOAuthFlows) flows;
