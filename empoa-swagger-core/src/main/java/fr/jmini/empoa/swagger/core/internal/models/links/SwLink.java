 ...
 * the License.
 ******************************************************************************/
package fr.jmini.empoa.swagger.core.internal.models.links;
...
public class SwLink implements Link {
    ...
    private fr.jmini.empoa.swagger.core.internal.models.servers.SwServer _server;

    private void initServer() {
        if (_swLink.getServer() == null) {
            _server = null;
        } else if (_server == null) {
            _server = new fr.jmini.empoa.swagger.core.internal.models.servers.SwServer(_swLink.getServer());
        }
    }
    ...
    public void setServer(org.eclipse.microprofile.openapi.models.servers.Server server) {
        if (server != null) {
            ...
            _server = (fr.jmini.empoa.swagger.core.internal.models.servers.SwServer) server;
