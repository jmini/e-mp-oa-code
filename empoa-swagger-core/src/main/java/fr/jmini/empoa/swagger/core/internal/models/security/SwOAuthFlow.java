...
public class SwOAuthFlow implements OAuthFlow {
    ...
    private fr.jmini.empoa.swagger.core.internal.models.security.SwScopes _scopes;

    private void initScopes() {
        if (_swOAuthFlow.getScopes() == null) {
            _scopes = null;
        } else if (_scopes == null) {
            _scopes = new fr.jmini.empoa.swagger.core.internal.models.security.SwScopes(_swOAuthFlow.getScopes());
        }
    }
    ...
    public void setScopes(org.eclipse.microprofile.openapi.models.security.Scopes scopes) {
        if (scopes != null) {
            if (!(scopes instanceof fr.jmini.empoa.swagger.core.internal.models.security.SwScopes)) {
                throw new IllegalArgumentException("Unexpected type: " + scopes);
            }
            _scopes = (fr.jmini.empoa.swagger.core.internal.models.security.SwScopes) scopes;
