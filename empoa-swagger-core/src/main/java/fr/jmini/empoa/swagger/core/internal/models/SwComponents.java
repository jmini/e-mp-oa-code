 ...
 * the License.
 ******************************************************************************/
package fr.jmini.empoa.swagger.core.internal.models;
...
public class SwComponents implements Components {
    ...
    private java.util.Map<String, fr.jmini.empoa.swagger.core.internal.models.media.SwSchema> _schemas;
        ...
        if (_swComponents.getSchemas() == null) {
            ...
            _schemas = _swComponents.getSchemas()
                    ...
                    .collect(java.util.stream.Collectors.toMap(
                            ...
                            e -> new fr.jmini.empoa.swagger.core.internal.models.media.SwSchema(e.getValue()),
                            (k1, k2) -> {
                                throw new IllegalStateException(String.format("Duplicate key %s", k1));
                            },
                            () -> new java.util.LinkedHashMap<String, fr.jmini.empoa.swagger.core.internal.models.media.SwSchema>()));
        }
    }
    ...
    public Components addSchema(String key, org.eclipse.microprofile.openapi.models.media.Schema schema) {
        if (!(schema instanceof fr.jmini.empoa.swagger.core.internal.models.media.SwSchema)) {
            throw new IllegalArgumentException("Unexpected type: " + schema);
        }
        fr.jmini.empoa.swagger.core.internal.models.media.SwSchema value = (fr.jmini.empoa.swagger.core.internal.models.media.SwSchema) schema;
        initSchemas();
        if (_schemas == null) {
    ...
    private java.util.Map<String, fr.jmini.empoa.swagger.core.internal.models.responses.SwAPIResponse> _responses;
    ...
    private void initResponses() {
        if (_swComponents.getResponses() == null) {
            ...
            _responses = _swComponents.getResponses()
                    ...
                    .collect(java.util.stream.Collectors.toMap(
                            java.util.Map.Entry::getKey,
                            e -> new fr.jmini.empoa.swagger.core.internal.models.responses.SwAPIResponse(e.getValue()),
                            (k1, k2) -> {
                                throw new IllegalStateException(String.format("Duplicate key %s", k1));
                            },
                            () -> new java.util.LinkedHashMap<String, fr.jmini.empoa.swagger.core.internal.models.responses.SwAPIResponse>()));
        }
    }
    ...
    public Components addResponse(String key, org.eclipse.microprofile.openapi.models.responses.APIResponse aPIResponse) {
        if (!(aPIResponse instanceof fr.jmini.empoa.swagger.core.internal.models.responses.SwAPIResponse)) {
            throw new IllegalArgumentException("Unexpected type: " + aPIResponse);
        }
        fr.jmini.empoa.swagger.core.internal.models.responses.SwAPIResponse value = (fr.jmini.empoa.swagger.core.internal.models.responses.SwAPIResponse) aPIResponse;
        initResponses();
        if (_responses == null) {
    ...
    private java.util.Map<String, fr.jmini.empoa.swagger.core.internal.models.parameters.SwParameter> _parameters;
    ...
    private void initParameters() {
        if (_swComponents.getParameters() == null) {
            ...
            _parameters = _swComponents.getParameters()
                    ...
                    .collect(java.util.stream.Collectors.toMap(
                            java.util.Map.Entry::getKey,
                            e -> new fr.jmini.empoa.swagger.core.internal.models.parameters.SwParameter(e.getValue()),
                            (k1, k2) -> {
                                throw new IllegalStateException(String.format("Duplicate key %s", k1));
                            },
                            () -> new java.util.LinkedHashMap<String, fr.jmini.empoa.swagger.core.internal.models.parameters.SwParameter>()));
        }
    }
    ...
    public Components addParameter(String key, org.eclipse.microprofile.openapi.models.parameters.Parameter parameter) {
        if (!(parameter instanceof fr.jmini.empoa.swagger.core.internal.models.parameters.SwParameter)) {
            throw new IllegalArgumentException("Unexpected type: " + parameter);
        }
        fr.jmini.empoa.swagger.core.internal.models.parameters.SwParameter value = (fr.jmini.empoa.swagger.core.internal.models.parameters.SwParameter) parameter;
        initParameters();
        if (_parameters == null) {
    ...
    private java.util.Map<String, fr.jmini.empoa.swagger.core.internal.models.examples.SwExample> _examples;
    ...
    private void initExamples() {
        if (_swComponents.getExamples() == null) {
            ...
            _examples = _swComponents.getExamples()
                    ...
                    .collect(java.util.stream.Collectors.toMap(
                            java.util.Map.Entry::getKey,
                            e -> new fr.jmini.empoa.swagger.core.internal.models.examples.SwExample(e.getValue()),
                            (k1, k2) -> {
                                throw new IllegalStateException(String.format("Duplicate key %s", k1));
                            },
                            () -> new java.util.LinkedHashMap<String, fr.jmini.empoa.swagger.core.internal.models.examples.SwExample>()));
        }
    }
    ...
    public Components addExample(String key, org.eclipse.microprofile.openapi.models.examples.Example example) {
        if (!(example instanceof fr.jmini.empoa.swagger.core.internal.models.examples.SwExample)) {
            throw new IllegalArgumentException("Unexpected type: " + example);
        }
        fr.jmini.empoa.swagger.core.internal.models.examples.SwExample value = (fr.jmini.empoa.swagger.core.internal.models.examples.SwExample) example;
        initExamples();
        if (_examples == null) {
    ...
    private java.util.Map<String, fr.jmini.empoa.swagger.core.internal.models.parameters.SwRequestBody> _requestBodies;
    ...
    private void initRequestBodies() {
        if (_swComponents.getRequestBodies() == null) {
            ...
            _requestBodies = _swComponents.getRequestBodies()
                    ...
                    .collect(java.util.stream.Collectors.toMap(
                            java.util.Map.Entry::getKey,
                            e -> new fr.jmini.empoa.swagger.core.internal.models.parameters.SwRequestBody(e.getValue()),
                            (k1, k2) -> {
                                throw new IllegalStateException(String.format("Duplicate key %s", k1));
                            },
                            () -> new java.util.LinkedHashMap<String, fr.jmini.empoa.swagger.core.internal.models.parameters.SwRequestBody>()));
        }
    }
    ...
    public Components addRequestBody(String key, org.eclipse.microprofile.openapi.models.parameters.RequestBody requestBody) {
        if (!(requestBody instanceof fr.jmini.empoa.swagger.core.internal.models.parameters.SwRequestBody)) {
            throw new IllegalArgumentException("Unexpected type: " + requestBody);
        }
        fr.jmini.empoa.swagger.core.internal.models.parameters.SwRequestBody value = (fr.jmini.empoa.swagger.core.internal.models.parameters.SwRequestBody) requestBody;
        initRequestBodies();
        if (_requestBodies == null) {
    ...
    private java.util.Map<String, fr.jmini.empoa.swagger.core.internal.models.headers.SwHeader> _headers;
    ...
    private void initHeaders() {
        if (_swComponents.getHeaders() == null) {
            ...
            _headers = _swComponents.getHeaders()
                    ...
                    .collect(java.util.stream.Collectors.toMap(
                            java.util.Map.Entry::getKey,
                            e -> new fr.jmini.empoa.swagger.core.internal.models.headers.SwHeader(e.getValue()),
                            (k1, k2) -> {
                                throw new IllegalStateException(String.format("Duplicate key %s", k1));
                            },
                            () -> new java.util.LinkedHashMap<String, fr.jmini.empoa.swagger.core.internal.models.headers.SwHeader>()));
        }
    }
    ...
    public Components addHeader(String key, org.eclipse.microprofile.openapi.models.headers.Header header) {
        if (!(header instanceof fr.jmini.empoa.swagger.core.internal.models.headers.SwHeader)) {
            throw new IllegalArgumentException("Unexpected type: " + header);
        }
        fr.jmini.empoa.swagger.core.internal.models.headers.SwHeader value = (fr.jmini.empoa.swagger.core.internal.models.headers.SwHeader) header;
        initHeaders();
        if (_headers == null) {
    ...
    private java.util.Map<String, fr.jmini.empoa.swagger.core.internal.models.security.SwSecurityScheme> _securitySchemes;
    ...
    private void initSecuritySchemes() {
        if (_swComponents.getSecuritySchemes() == null) {
            ...
            _securitySchemes = _swComponents.getSecuritySchemes()
                    ...
                    .collect(java.util.stream.Collectors.toMap(
                            java.util.Map.Entry::getKey,
                            e -> new fr.jmini.empoa.swagger.core.internal.models.security.SwSecurityScheme(e.getValue()),
                            (k1, k2) -> {
                                throw new IllegalStateException(String.format("Duplicate key %s", k1));
                            },
                            () -> new java.util.LinkedHashMap<String, fr.jmini.empoa.swagger.core.internal.models.security.SwSecurityScheme>()));
        }
    }
    ...
    public Components addSecurityScheme(String key, org.eclipse.microprofile.openapi.models.security.SecurityScheme securityScheme) {
        if (!(securityScheme instanceof fr.jmini.empoa.swagger.core.internal.models.security.SwSecurityScheme)) {
            throw new IllegalArgumentException("Unexpected type: " + securityScheme);
        }
        fr.jmini.empoa.swagger.core.internal.models.security.SwSecurityScheme value = (fr.jmini.empoa.swagger.core.internal.models.security.SwSecurityScheme) securityScheme;
        initSecuritySchemes();
        if (_securitySchemes == null) {
    ...
    private java.util.Map<String, fr.jmini.empoa.swagger.core.internal.models.links.SwLink> _links;
    ...
    private void initLinks() {
        if (_swComponents.getLinks() == null) {
            ...
            _links = _swComponents.getLinks()
                    ...
                    .collect(java.util.stream.Collectors.toMap(
                            java.util.Map.Entry::getKey,
                            e -> new fr.jmini.empoa.swagger.core.internal.models.links.SwLink(e.getValue()),
                            (k1, k2) -> {
                                throw new IllegalStateException(String.format("Duplicate key %s", k1));
                            },
                            () -> new java.util.LinkedHashMap<String, fr.jmini.empoa.swagger.core.internal.models.links.SwLink>()));
        }
    }
    ...
    public Components addLink(String key, org.eclipse.microprofile.openapi.models.links.Link link) {
        if (!(link instanceof fr.jmini.empoa.swagger.core.internal.models.links.SwLink)) {
            throw new IllegalArgumentException("Unexpected type: " + link);
        }
        fr.jmini.empoa.swagger.core.internal.models.links.SwLink value = (fr.jmini.empoa.swagger.core.internal.models.links.SwLink) link;
        initLinks();
        if (_links == null) {
    ...
    private java.util.Map<String, fr.jmini.empoa.swagger.core.internal.models.callbacks.SwCallback> _callbacks;
    ...
    private void initCallbacks() {
        if (_swComponents.getCallbacks() == null) {
            ...
            _callbacks = _swComponents.getCallbacks()
                    ...
                    .collect(java.util.stream.Collectors.toMap(
                            java.util.Map.Entry::getKey,
                            e -> new fr.jmini.empoa.swagger.core.internal.models.callbacks.SwCallback(e.getValue()),
                            (k1, k2) -> {
                                throw new IllegalStateException(String.format("Duplicate key %s", k1));
                            },
                            () -> new java.util.LinkedHashMap<String, fr.jmini.empoa.swagger.core.internal.models.callbacks.SwCallback>()));
        }
    }
    ...
    public Components addCallback(String key, org.eclipse.microprofile.openapi.models.callbacks.Callback callback) {
        if (!(callback instanceof fr.jmini.empoa.swagger.core.internal.models.callbacks.SwCallback)) {
            throw new IllegalArgumentException("Unexpected type: " + callback);
        }
        fr.jmini.empoa.swagger.core.internal.models.callbacks.SwCallback value = (fr.jmini.empoa.swagger.core.internal.models.callbacks.SwCallback) callback;
        initCallbacks();
        if (_callbacks == null) {
