package fr.jmini.empoa.swagger.core.internal.models.callbacks;
...
public class SwCallback implements Callback {
    ...
    private java.util.Map<String, fr.jmini.empoa.swagger.core.internal.models.SwPathItem> _pathItems;
        ...
        if (_swCallback == null) {
            ...
            _pathItems = _swCallback
                    ...
                    .collect(java.util.stream.Collectors.toMap(
                            ...
                            e -> new fr.jmini.empoa.swagger.core.internal.models.SwPathItem(e.getValue()),
                            (k1, k2) -> {
                                throw new IllegalStateException(String.format("Duplicate key %s", k1));
                            },
                            () -> new java.util.LinkedHashMap<String, fr.jmini.empoa.swagger.core.internal.models.SwPathItem>()));
        }
    }
    ...
    public Callback addPathItem(String key, org.eclipse.microprofile.openapi.models.PathItem pathItem) {
        if (!(pathItem instanceof fr.jmini.empoa.swagger.core.internal.models.SwPathItem)) {
            throw new IllegalArgumentException("Unexpected type: " + pathItem);
        }
        fr.jmini.empoa.swagger.core.internal.models.SwPathItem value = (fr.jmini.empoa.swagger.core.internal.models.SwPathItem) pathItem;
        initPathItems();
        if (_pathItems == null) {
            _pathItems = new java.util.LinkedHashMap<>();
        }
