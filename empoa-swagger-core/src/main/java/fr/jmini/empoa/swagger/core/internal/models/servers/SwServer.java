...
public class SwServer implements Server {
    ...
    private fr.jmini.empoa.swagger.core.internal.models.servers.SwServerVariables _variables;

    private void initVariables() {
        if (_swServer.getVariables() == null) {
            _variables = null;
        } else if (_variables == null) {
            _variables = new fr.jmini.empoa.swagger.core.internal.models.servers.SwServerVariables(_swServer.getVariables());
        }
    }
    ...
    public void setVariables(org.eclipse.microprofile.openapi.models.servers.ServerVariables variables) {
        if (variables != null) {
            if (!(variables instanceof fr.jmini.empoa.swagger.core.internal.models.servers.SwServerVariables)) {
                throw new IllegalArgumentException("Unexpected type: " + variables);
            }
            _variables = (fr.jmini.empoa.swagger.core.internal.models.servers.SwServerVariables) variables;
