...
public class CodeBlockConverter {
    ...
    public static CodeBlock createComponents(org.eclipse.microprofile.openapi.models.Components components) {
        ...
        list.add(CodeBlock.of("createObject($T.class)", org.eclipse.microprofile.openapi.models.Components.class));
    ...
    public static CodeBlock createExternalDocumentation(org.eclipse.microprofile.openapi.models.ExternalDocumentation externalDocumentation) {
        List<CodeBlock> list = new ArrayList<>();
        list.add(CodeBlock.of("createObject($T.class)", org.eclipse.microprofile.openapi.models.ExternalDocumentation.class));
    ...
    public static CodeBlock createHeader(org.eclipse.microprofile.openapi.models.headers.Header header) {
        ...
        if (header.getSchema() != null) {
            list.add(CodeBlock.of("schema($L\n)", createSchema(header.getSchema())));
        }
        ...
        if (header.getContent() != null) {
            list.add(CodeBlock.of("content($L\n)", createContent(header.getContent())));
        }
        return CodeBlock.join(list, "\n.");
    }
    public static CodeBlock createContact(org.eclipse.microprofile.openapi.models.info.Contact contact) {
        List<CodeBlock> list = new ArrayList<>();
        list.add(CodeBlock.of("createObject($T.class)", org.eclipse.microprofile.openapi.models.info.Contact.class));
    ...
    public static CodeBlock createInfo(org.eclipse.microprofile.openapi.models.info.Info info) {
        List<CodeBlock> list = new ArrayList<>();
        list.add(CodeBlock.of("createObject($T.class)", org.eclipse.microprofile.openapi.models.info.Info.class));
        ...
        if (info.getContact() != null) {
            list.add(CodeBlock.of("contact($L\n)", createContact(info.getContact())));
        }
        if (info.getLicense() != null) {
            list.add(CodeBlock.of("license($L\n)", createLicense(info.getLicense())));
        }
    ...
    public static CodeBlock createLicense(org.eclipse.microprofile.openapi.models.info.License license) {
        List<CodeBlock> list = new ArrayList<>();
        list.add(CodeBlock.of("createObject($T.class)", org.eclipse.microprofile.openapi.models.info.License.class));
    ...
    public static CodeBlock createLink(org.eclipse.microprofile.openapi.models.links.Link link) {
        ...
        if (link.getServer() != null) {
            list.add(CodeBlock.of("server($L\n)", createServer(link.getServer())));
        }
    ...
    public static CodeBlock createContent(org.eclipse.microprofile.openapi.models.media.Content content) {
        List<CodeBlock> list = new ArrayList<>();
        list.add(CodeBlock.of("createObject($T.class)", org.eclipse.microprofile.openapi.models.media.Content.class));
        for (java.util.Map.Entry<String, org.eclipse.microprofile.openapi.models.media.MediaType> entry : content.entrySet()) {
            list.add(CodeBlock.of("addMediaType($S, $L\n)", entry.getKey(), createMediaType(entry.getValue())));
        }
        return CodeBlock.join(list, "\n.");
    }
    public static CodeBlock createDiscriminator(org.eclipse.microprofile.openapi.models.media.Discriminator discriminator) {
        List<CodeBlock> list = new ArrayList<>();
        list.add(CodeBlock.of("createObject($T.class)", org.eclipse.microprofile.openapi.models.media.Discriminator.class));
    ...
    public static CodeBlock createEncoding(org.eclipse.microprofile.openapi.models.media.Encoding encoding) {
        List<CodeBlock> list = new ArrayList<>();
        list.add(CodeBlock.of("createObject($T.class)", org.eclipse.microprofile.openapi.models.media.Encoding.class));
    ...
    public static CodeBlock createMediaType(org.eclipse.microprofile.openapi.models.media.MediaType mediaType) {
        List<CodeBlock> list = new ArrayList<>();
        list.add(CodeBlock.of("createObject($T.class)", org.eclipse.microprofile.openapi.models.media.MediaType.class));
    ...
    public static CodeBlock createSchema(org.eclipse.microprofile.openapi.models.media.Schema schema) {
        ...
        if (schema.getProperties() != null) {
            for (java.util.Map.Entry<String, org.eclipse.microprofile.openapi.models.media.Schema> entry : schema.getProperties().entrySet()) {
                list.add(CodeBlock.of("addProperty($S, $L\n)", entry.getKey(), createSchema(entry.getValue())));
            }
        }
    ...
    public static CodeBlock createXML(org.eclipse.microprofile.openapi.models.media.XML xML) {
        List<CodeBlock> list = new ArrayList<>();
        list.add(CodeBlock.of("createObject($T.class)", org.eclipse.microprofile.openapi.models.media.XML.class));
        if (xML.getName() != null) {
    ...
    public static CodeBlock createAPIResponses(org.eclipse.microprofile.openapi.models.responses.APIResponses aPIResponses) {
        List<CodeBlock> list = new ArrayList<>();
        list.add(CodeBlock.of("createObject($T.class)", org.eclipse.microprofile.openapi.models.responses.APIResponses.class));
        for (java.util.Map.Entry<String, org.eclipse.microprofile.openapi.models.responses.APIResponse> entry : aPIResponses.entrySet()) {
            list.add(CodeBlock.of("addApiResponse($S, $L\n)", entry.getKey(), createAPIResponse(entry.getValue())));
        }
        if (aPIResponses.getDefault() != null) {
            list.add(CodeBlock.of("defaultValue($L\n)", createAPIResponse(aPIResponses.getDefault())));
        }
        return CodeBlock.join(list, "\n.");
    }
    public static CodeBlock createOAuthFlow(org.eclipse.microprofile.openapi.models.security.OAuthFlow oAuthFlow) {
        List<CodeBlock> list = new ArrayList<>();
        list.add(CodeBlock.of("createObject($T.class)", org.eclipse.microprofile.openapi.models.security.OAuthFlow.class));
    ...
    public static CodeBlock createServer(org.eclipse.microprofile.openapi.models.servers.Server server) {
        List<CodeBlock> list = new ArrayList<>();
        list.add(CodeBlock.of("createObject($T.class)", org.eclipse.microprofile.openapi.models.servers.Server.class));
    ...
    public static CodeBlock createServerVariable(org.eclipse.microprofile.openapi.models.servers.ServerVariable serverVariable) {
        List<CodeBlock> list = new ArrayList<>();
        list.add(CodeBlock.of("createObject($T.class)", org.eclipse.microprofile.openapi.models.servers.ServerVariable.class));
    ...
    public static CodeBlock createServerVariables(org.eclipse.microprofile.openapi.models.servers.ServerVariables serverVariables) {
        ...
        for (java.util.Map.Entry<String, org.eclipse.microprofile.openapi.models.servers.ServerVariable> entry : serverVariables.entrySet()) {
            list.add(CodeBlock.of("addServerVariable($S, $L\n)", entry.getKey(), createServerVariable(entry.getValue())));
        }
        return CodeBlock.join(list, "\n.");
    }
    public static CodeBlock createTag(org.eclipse.microprofile.openapi.models.tags.Tag tag) {
        List<CodeBlock> list = new ArrayList<>();
        list.add(CodeBlock.of("createObject($T.class)", org.eclipse.microprofile.openapi.models.tags.Tag.class));
        if (tag.getName() != null) {
