...
/**
 * This test covers construction of the OpenAPI model. It verifies that the implementation can create instances of all of the Constructible interfaces and then invokes methods (including getters, setters and builders) on those instances to
 * verify that they behave correctly.
 */
// Copy of "org.eclipse.microprofile.openapi.tck.ModelConstructionTest" because of https://github.com/eclipse/microprofile-open-api/issues/270
public class ModelConstructionPatchedTest {
    ...
    private void processExtensible(Extensible e) {
        final String extensionName1 = "x-" + e.getClass()
                .getName() + "-1";
        final Object obj1 = new Object();
        final String extensionName2 = "x-" + e.getClass()
                .getName() + "-2";
    ...
    private <T> void checkListEntry(List<T> list, T value) {
        ...
        assertTrue(list.stream()
                .anyMatch((v) -> v == value), "The list is expected to contain the value: " + value);
    }
